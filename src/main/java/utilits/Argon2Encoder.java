 ...
 */
 ...
 public class Argon2Encoder implements PasswordEncoder {
     ...
     public Argon2Encoder(int saltLength, int hashLength, int parallelism, int memory, int iterations) {
     ...
     public Argon2Encoder(String salt, int hashLength, int parallelism, int memory, int iterations) {
        this.hashLength = hashLength;
        this.parallelism = parallelism;
        this.memory = memory;
        this.iterations = iterations;
     ...
     public String encode(CharSequence rawPassword) {
        ...
        }else if(null!= this.salt && !this.salt.isEmpty()){
            salt = getSaltBytes(this.salt);
        }else{
            salt = new byte[16];
        }
